...
public class OurTests {
    ...
    public static void testValueClassification(String[] values, String type) {
    ...
    public static void main(String[] args) {
        ...
        type_valid_values.put("int", new String[]{"5", "-3", "+001"});
        ...
        type_valid_values.forEach((key, value) -> testValueClassification(value, key));
